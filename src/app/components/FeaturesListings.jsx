  ...
  return (
    <div className="relative carousel w-full flex flex-col justify-center mt-4">
      ...
      <Link href="#" className="relative w-full ">
        <div className="absolute bottom-0 p-4 left-0 pl-16 bg-black bg-opacity-90 text-white hover:pr-12 hover:bg-opacity-75 transition-all duration-300 ease-in-out">
          ...
          <h4 className="text-3xl mt-4">{listings[currentListing].price}</h4>
        </div>
      </Link>
